...
@Injectable()
export class ApplicantInvestmentsResolver implements Resolve<any> {

  constructor(private processingService: FirebaseArrayProcessingService) { }

  resolve(): Observable<any> | Promise<any> {
    return this.processingService.getArray(`/application/${localStorage.getItem('applicationId')}/maintenance/applicant/investments`);
  }
}
